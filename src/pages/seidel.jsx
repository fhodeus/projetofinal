...
export default class Seidel extends Component {
  ...
  handleSubmit(event) {
    ...
    while (i < limite) {
      ...
      valorx1 = 1 / primeiralinha.x1 * (primeiralinha.resultado - (primeiralinha.x2 * valorx2) - (primeiralinha.x3 * valorx3))
      valorx2 = 1 / segundalinha.x2 * (segundalinha.resultado - (segundalinha.x1 * valorx1) - (segundalinha.x3 * valorx3))
      valorx3 = 1 / terceiralinha.x3 * (terceiralinha.resultado - (terceiralinha.x1 * valorx1) - (terceiralinha.x2 * valorx2))
